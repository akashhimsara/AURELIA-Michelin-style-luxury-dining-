...
import { ShieldCheck, RefreshCw, Check, Calendar, Clock, Users, HeartHandshake } from "lucide-react";
...
export function SpaBookingForm() {
  ...
  const selectedTreatmentKey = watch("treatment") as "stones" | "facial" | "detox";
  const selectedTreatment = spaTreatments[selectedTreatmentKey] || spaTreatments.stones;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              {...register("treatment")}
            >
              <option value="stones">Himalayan Salt Stones (&pound;180 / 90m)</option>
              <option value="facial">Gold Leaf Facial (&pound;240 / 60m)</option>
              <option value="detox">Seaweed Body Wrap (&pound;150 / 75m)</option>
            </select>
            {errors.treatment && (
