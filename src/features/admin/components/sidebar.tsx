...
import { LayoutDashboard, CalendarRange, UtensilsCrossed, LogOut, Loader2, Inbox, Home, Users, Heart, Sparkles } from "lucide-react";
...
export function Sidebar() {
  ...
  const menuItems = [
    ...
    { label: "Events Catalog", href: "/admin/events", icon: Sparkles },
