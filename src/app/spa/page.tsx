...
const therapies = [
  {
    ...
    duration: "90 Minutes",
    rate: "£180 per head",
    image: "/spa-massage.png",
  },
  {
    title: "Gold Leaf Facial Regenerator",
    subtitle: "Anti-Ageing Rituals",
    ...
    duration: "60 Minutes",
    rate: "£240 per head",
    image: "/spa-facial.png",
  },
  {
    title: "Organic Seaweed Body Wrap",
    subtitle: "Botanical Detox",
      ...
      <Section className="py-20 bg-black">
        <Container className="space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {therapies.map((tp) => (
              <article key={tp.title} className="group relative border border-gold/10 bg-charcoal/40 rounded-sm overflow-hidden gold-border-glow shadow-elevation flex flex-col justify-between">
                ...
                <div className="p-5 pt-0 border-t border-gold/5 mt-4 space-y-3">
                  <div className="flex justify-between items-center text-[10px] text-zinc-300 font-sans font-light">
                    ...
                    <span className="text-gold font-medium">{tp.rate}</span>
                  </div>
                </div>
              </article>
            ))}
